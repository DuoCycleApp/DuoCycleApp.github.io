<template>
	<div class="data-at-glance">
		<p class="description-light">
			On iPhone, your workout data is organized in tiles. Just tap on one of
			them to get its data to the top.
		</p>
		<img
			class="contained"
		...
		/>
		<p class="description-light">
			On Apple Watch, your data is organized in lines. To switch the line, just
		...
		<div id="switcher" class="centered">
			...
			<button class="btn-nobg" id="right-arrow" v-on:click="incrementViewMode">
				<img
					class="buttonimg"
		...
		<p id="mode-description" class="centered">
			{{ viewModes[viewMode].description }}
		</p>
	</div>
</template>
